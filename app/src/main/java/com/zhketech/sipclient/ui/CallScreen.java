...
public class CallScreen extends Activity implements DialogInterface.OnClickListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case SPEAKER_MENU_ITEM:
			Receiver.engine(this).speaker(AudioManager.STREAM_SYSTEM);
		...
		case VIDEO_MENU_ITEM:
			...
			try {
				intent = new Intent(this, com.zhketech.sipclient.ui.VideoCamera.class);
					...
					for (;;) {
						...
						if (videopacket.getPayloadLength() > 200) {
							if (intent != null) {
								...
								Intent i = new Intent(mContext, com.zhketech.sipclient.ui.VideoCamera.class);
