...
{   
    ...
    protected void onSaveRingtone(Uri ringtoneUri) 
    {
		...
		edit.putString(com.zhketech.sipclient.ui.Settings.PREF_SIPRINGTONE, ringtoneUri != null ? ringtoneUri.toString() : com.zhketech.sipclient.ui.Settings.DEFAULT_SIPRINGTONE);		
		edit.commit();        
    }
    ...
    {
        String uriString = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.zhketech.sipclient.ui.Settings.PREF_SIPRINGTONE,
