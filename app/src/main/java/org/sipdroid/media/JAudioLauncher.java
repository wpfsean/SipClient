...
{  
   ...
   {  log=logger;
      ...
      try
      {
    	 ...
    	 if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.zhketech.sipclient.ui.Settings.PREF_CALLRECORD,
					com.zhketech.sipclient.ui.Settings.DEFAULT_CALLRECORD))
