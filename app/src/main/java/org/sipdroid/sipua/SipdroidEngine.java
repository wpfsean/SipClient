...
import com.zhketech.sipclient.ui.ChangeAccount;
import com.zhketech.sipclient.ui.LoopAlarm;
import com.zhketech.sipclient.ui.Receiver;
import com.zhketech.sipclient.ui.Settings;
...
public class SipdroidEngine implements RegisterAgentListener {
	...
	public void UpdateLines() {
		LINES = PreferenceManager.getDefaultSharedPreferences(getUIContext()).getInt(com.zhketech.sipclient.ui.AccountSettings.PREF_LINES, LINES);
	}
	...
	public boolean StartEngine() {
			...
			@SuppressLint("WifiManagerLeak") WifiManager wm = (WifiManager) getUIContext().getSystemService(Context.WIFI_SERVICE);
			if (wl == null) {
		...
		//			SipStack.log_path = "/data/data/org.sipdroid.sipua";
					...
					String version = "Sipdroid/" + "1.0" + "/" + Build.MODEL;
